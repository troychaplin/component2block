...
- **Registry-driven** — `CATEGORY_REGISTRY` in `src/types.ts` defines behavior for all 13 token categories. Adding a new category to this registry enables it across every generator automatically.
